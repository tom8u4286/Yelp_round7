...
"""open the file of vector200,let sys.argv[1] = data/line-data/vectors/200dim/restaurant_1_vector200.txt"""
...
coo_file_name = "../data/line-data/cooccurrence/restaurant_%s_cooccur.txt"%re.search("[0-9]+",sys.argv[1].split("_")[1]).group(0)
